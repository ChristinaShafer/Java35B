...
public class FileIO {
	...
	public Automobile readPropData(Properties props) {
		...
		a1.setModel(model);
		float base=Float.parseFloat(props.getProperty("BasePrice"));
		a1.setBasePrice(base);
		...
		while (props.getProperty(optionString)!=null) {  //if the optionSet name exists
			...
			if (Automobile.DEBUG)
				System.out.println(optionString +": " + optionName +"\n");
	...
	public Automobile deSerializeAuto(int year, String make, String model) throws AutoException {
		...
		try {
			...
			String fileToBeRead = "C:\\Users\\cljsh\\OneDrive\\Desktop\\Java35B\\lab5Server\\";
